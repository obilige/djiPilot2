export const CURRENT_CONFIG = {
  ...
  // http
  baseURL: 'http://211.189.132.21:6789/', // This url must end with "/". Example: 'http://192.168.1.1:6789/'
  websocketURL: 'ws://211.189.132.21:6789/api/v1/ws',  // Example: 'ws://192.168.1.1:6789/api/v1/ws'

  // livestreaming
  // RTMP  Note: This IP is the address of the streaming server. If you want to see livestream on web page, you need to convert the RTMP stream to WebRTC stream.
  rtmpURL: 'rtmp://211.189.132.21/app/stream/',  // Example: 'rtmp://192.168.1.1/live/' 
